...
public class App {
    ...
    private static void playGame (Board board,Scanner userInput,StateManager stateManager,Symbol[] symbols,Player[] players,int turn){
